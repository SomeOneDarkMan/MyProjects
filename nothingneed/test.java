...
public class test {
 ...
 User Kate = new User("Kate");
        User Karen = new User("Kate");
        User Karen2 = new User("Masha");
        /*System.out.println(Masha);
        System.out.println(Kate);
        Masha.subscribe(Kate);
        Kate.subscribe(Masha);
        System.out.println(Masha.isSubscribed(Kate));
        System.out.println(Kate.isSubscribed(Masha));
        System.out.println(Kate.isFriend(Masha));
        System.out.println(Masha.isFriend(Kate));*/
        /*Masha.sendMessage(Kate,"Привет");
        Kate.sendMessage(Masha,"Привет");
        Kate.sendMessage(Masha,"Дура");
        Masha.sendMessage(Kate,"Сама дура");
        Masha.sendMessage(Karen,"Привет");


        MessageDatabase.showDialog(Masha,Kate);
        ...
        while (exit){
            ...
            if(s.equalsIgnoreCase("sendmes,Masha")){
                Scanner scannere=new Scanner(System.in);
                String s1 =scannere.nextLine();
                Karen2.sendMessage(Karen,s1);
            ...
            if(s.equalsIgnoreCase("show")){
                MessageDatabase.showDialog(Karen2,Karen);
